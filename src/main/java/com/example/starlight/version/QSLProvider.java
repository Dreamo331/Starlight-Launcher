...
/**
 * QSL (Quilt Standard Libraries) / QFAPI (Quilted Fabric API) 版本查询提供器
 * 通过 Modrinth API 获取 QSL 的版本列表
 * QSL 在 Modrinth 上的项目 ID 为 qsl
 * API: https://api.modrinth.com/v2/project/qsl/version
 *
 * 每个版本包含:
 * - version_number: 版本号
 ...
 * - files[0].url: 下载地址
 */
public class QSLProvider implements LoaderProvider {
    private static final String MODRINTH_API = "https://api.modrinth.com/v2/project/qsl/version";

    public String name() { return "QSL"; }
    public String icon() { return ""; }
    public String fallbackUrl() { return "https://modrinth.com/mod/qsl"; }
