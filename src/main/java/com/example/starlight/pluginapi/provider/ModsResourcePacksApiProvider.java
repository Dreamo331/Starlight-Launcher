...
/**
 * 功能类（包装）：{@code mods/resourcepacks} —— 列出资源包。
 *
 ...
 */
public final class ModsResourcePacksApiProvider implements ApiProvider {
    ...
    public byte[] handle(ApiRequest request) throws Exception {
        ...
        List<PackInfo> packs = ModService.listResourcePacks(gameDir);
